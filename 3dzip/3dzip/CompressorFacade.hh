...
class CompressorFacade : public ManifoldCompressorFacade
{
    typedef boost::function<void(StitchSymbol)> StitchOutput;
    StitchOutput sop;

    virtual bool has_attributes(const HDS::Handle_t v);

public:
    CompressorFacade(HDS::Mesh& m, const StitchOutput& sop);
    virtual ~CompressorFacade() {}
};
